...
def settings():
    if request.method=='POST':
        ...
        if action=='preferences':
            ...
            current_user.seller_verification_status='pending'; current_user.seller_verified=False; current_user.pending_seller_name=seller_name; current_user.pending_seller_whatsapp=whatsapp; db.session.commit(); flash('Seller verification is handled through WhatsApp.'); return redirect(url_for('settings'))
